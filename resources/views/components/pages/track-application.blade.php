...
<style>
    ...
    .form-track input[type="text"]::placeholder {
        color: #6c757d;
        opacity: 0.7;
        font-size: 1.05rem; /* Larger placeholder text */
    }
    ...
    .form-track .text-danger {
        font-size: 1.05rem; /* Larger error text */
        color: #dc3545;
        margin-top: 10px;
    ...
    .result-card p {
        margin-bottom: 1rem;
        color: #495057;
        font-size: 1.05rem; /* Larger card text */
        line-height: 1.5;
    }
...
<div class="container">
    <div class="col-md-12">
        <div class="pg-title mb-4">
            <h1 class="display-5">Track Your Application</h1>
